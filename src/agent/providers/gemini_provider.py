"""Google Gemini Flash / Pro integration for AI exception investigation."""
...
class GeminiProvider(LLMProvider):
    """Integrates Google Gemini models with structured JSON output and temperature=0.0."""
    ...
    async def investigate(self, bundle: EvidenceBundle) -> AIInvestigationResult:
        ...
        payload = {
            "system_instruction": {
                "parts": [{"text": FINANCIAL_COT_SYSTEM_PROMPT}]
            },
            "contents": [
        ...
        return AIInvestigationResult(
            investigation_id=raw_result.get("investigation_id", f"INV-GEM-{bundle.target_record_id}"),
